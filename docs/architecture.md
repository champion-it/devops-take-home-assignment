...
![Terraform state in OBS](images/02-iac-tfstate-obs.png)

### Cluster provisioned

After `terraform apply` in production:

![CCE Turbo cluster running](images/02-iac-cce-cluster.png)

### Networking — EIP + ELB

Public EIP bound to a dedicated ELB (terminates TLS, fronts the cluster):

![EIP + ELB](images/02-iac-eip-elb.png)

### Apply output

![Terraform apply](images/02-iac-terraform-apply.png)
...
![CI/CD pipeline](images/04-cicd-pipeline.png)
...
![Argo CD app dashboard](images/04-cicd-argocd-apps.png)

Platform infrastructure (Envoy Gateway, Vault, VSO, routes) also managed
GitOps-style:

![Argo CD platform apps](images/04-cicd-argocd-infra.png)
...
![kubectl get pod -n devops-demo](images/05-k8s-pods-running.png)
...
![Discord alerts in channel](images/06-observability-discord-alerts.png)
...
![Demo frontend UI](images/07-demo-frontend-ui.png)
